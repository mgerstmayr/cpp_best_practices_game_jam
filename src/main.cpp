...
// configuration step. It creates a namespace called `cpp_best_practices_game_jam`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        cpp_best_practices_game_jam::cmake::project_name,
        cpp_best_practices_game_jam::cmake::project_version));// version string, acquired
